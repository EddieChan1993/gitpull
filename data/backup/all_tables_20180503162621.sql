DROP TABLE IF EXISTS gitpull_imgs;
CREATE TABLE `gitpull_imgs` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8mb4 COMMENT='图片管理';
DROP TABLE IF EXISTS gitpull_log;
CREATE TABLE `gitpull_log` (
...
INSERT INTO `gitpull_log` VALUES 
...
DROP TABLE IF EXISTS gitpull_menu;
CREATE TABLE `gitpull_menu` (
...
INSERT INTO `gitpull_menu` VALUES 
...
('345','0','admin','Default','default','','0','0','模板','','','0','345'),
('346','345','admin','Test','homePage','','0','1','模板1','','','0','345-346'),
('347','345','admin','Test2','homePage','','0','1','模板2','','','0','345-347'),
('348','0','admin','GitThink','homePage','','0','1','Git项目管理','fa fa-github-alt','','0','348');
DROP TABLE IF EXISTS gitpull_options;
CREATE TABLE `gitpull_options` (
...
INSERT INTO `gitpull_options` VALUES 
...
('6','site_options','{\"site_name\":\"GitPull\",\"site_addr\":\"\",\"site_admin_email\":\"\",\"tel\":\"\",\"icp\":\"\",\"site_copyright\":\"\"}','1','1'),
...
DROP TABLE IF EXISTS gitpull_posts;
CREATE TABLE `gitpull_posts` (
...
INSERT INTO `gitpull_posts` VALUES 
('6','1','','','1499226343','<p>123</p>','123','123','1','1','','','0','1','','0','{\"term_relation\":\"24\",\"thumb\":\"\"}','0','0','0','0');
DROP TABLE IF EXISTS gitpull_project;
CREATE TABLE `gitpull_project` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  ...
  `secret_token` varchar(255) DEFAULT NULL COMMENT '密码token',
  `path` varchar(255) DEFAULT NULL COMMENT '部署环境地址',
...
INSERT INTO `gitpull_role` VALUES 
...
DROP TABLE IF EXISTS gitpull_role_user;
CREATE TABLE `gitpull_role_user` (
...
INSERT INTO `gitpull_role_user` VALUES 
('14','39','2'),
('15','1','22'),
('16','1','23');
DROP TABLE IF EXISTS gitpull_term_relationships;
CREATE TABLE `gitpull_term_relationships` (
...
INSERT INTO `gitpull_term_relationships` VALUES 
('2','6','24','0','1');
DROP TABLE IF EXISTS gitpull_terms;
CREATE TABLE `gitpull_terms` (
...
INSERT INTO `gitpull_terms` VALUES 
('24','首页','','文章','sdfsdf213','0','0','0','','','','news','content','0','1');
DROP TABLE IF EXISTS gitpull_test;
CREATE TABLE `gitpull_test` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
INSERT INTO `gitpull_test` VALUES 
('1','0','','1499229055','0','0'),
('2','1','','1499229055','0','0'),
('3','0','','1499229055','0','0'),
('4','1','','1499229055','0','0'),
...
DROP TABLE IF EXISTS gitpull_users;
CREATE TABLE `gitpull_users` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
...
INSERT INTO `gitpull_widgets` VALUES 
